(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
    ...
    function srcAppComponentsListItemListItemComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      ListItemComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
    ...
    function srcAppServicesPhotosServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var PhotosService = function PhotosService() {
    ...
    function srcAppServicesStorageServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var StorageService = /*#__PURE__*/function () {
        ...
        _createClass(StorageService, [{
              ...
              return regeneratorRuntime.wrap(function _callee3$(_context3) {
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    case 0:
                      _context3.next = 2;
                      return this.storage.get('MyFavPhotos');

                    case 2:
                      fav = _context3.sent;
                      return _context3.abrupt("return", fav);
          ...
          key: "setFavPhotos",
          value: function setFavPhotos(array) {
            this.storage.set('MyFavPhotos', array);
          }
        }, {
          key: "getFavById",
          value: function getFavById(id) {
              ...
              return regeneratorRuntime.wrap(function _callee4$(_context4) {
                while (1) {
                  switch (_context4.prev = _context4.next) {
                    case 0:
                      _context4.next = 2;
                      return this.getFavPhotos();

                    case 2:
                      fav = _context4.sent;
                      index = fav ? fav.findIndex(function (item) {
                        return item.id == id;
                      }) : -1;
